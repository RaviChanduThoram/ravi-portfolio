...
function Skills() {
  ...
  return (
    <div id="skills" className="relative z-50 border-t my-12 lg:my-24 border-[#25213b]">
      ...
      <div className="w-full my-12 relative flex items-center">
        {/* Left Arrow */}
        <button
          onClick={scrollLeft}
          className="absolute left-0 z-10 p-2 bg-[#1a1443] text-white rounded-full shadow-lg"
        ...
        <button
          onClick={scrollRight}
          className="absolute right-0 z-10 p-2 bg-[#1a1443] text-white rounded-full shadow-lg"
